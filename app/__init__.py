...
app.register_blueprint(auth_routes, url_prefix='/api/tracks')
app.register_blueprint(auth_routes, url_prefix='/api/scores')
app.register_blueprint(auth_routes, url_prefix='/api/songs')
app.register_blueprint(auth_routes, url_prefix='/api/notes')
app.register_blueprint(auth_routes, url_prefix='/api/friends')
db.init_app(app)
Migrate(app, db)
