...
Revision ID: 9ff5c33d605b
Revises:
Create Date: 2024-06-10 04:52:13.587407
...
def upgrade():
    ...
    sa.Column('temp_track_id', sa.String(), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_unique_constraint('notes_temp_track_id_key', 'notes', ['temp_track_id'])
